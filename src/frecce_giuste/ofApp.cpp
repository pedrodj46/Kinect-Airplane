...
void ofApp::update(){
    ...
    if(smoothedForepoint.z<1600){
        ...
        ofVec3f smoothedForepointGreen(smoothedForepoint.x+80*sin(ofDegToRad(angleY+45)), smoothedForepoint.y+80*cos(ofDegToRad(angleY+45)), smoothedForepoint.z);
        sciaGreenVector.push_back(smoothedForepointGreen);
        ofVec3f smoothedForepointRed(smoothedForepoint.x+80*sin(ofDegToRad(angleY+135)), smoothedForepoint.y+80*cos(ofDegToRad(angleY+135)), smoothedForepoint.z);
        sciaRedVector.push_back(smoothedForepointRed);
        
        
        if(sciaWhiteVector.size() > 100){
...
void ofApp::draw(){
    ...
    airplane.drawFaces();
    airplane.setPosition(smoothedForepoint.x+80*sin(ofDegToRad(angleY+45)), smoothedForepoint.y+80*cos(ofDegToRad(angleY+45)), smoothedForepoint.z-5);
    airplane.drawFaces();
    airplane.setPosition(smoothedForepoint.x+80*sin(ofDegToRad(angleY+135)), smoothedForepoint.y+80*cos(ofDegToRad(angleY+135)), smoothedForepoint.z-5);
    airplane.drawFaces();
    ...
    ofSetColor(red);
    ofDrawBitmapString(" "+ofToString(sciaWhiteVector[0]), 0, 0);
